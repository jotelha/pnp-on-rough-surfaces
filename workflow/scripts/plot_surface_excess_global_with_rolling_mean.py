...
try:
    ...
    h_lim = config["surface_excess_global"]["hlim"]
...
try:
    ...
    h_ticks = config["surface_excess_global"]["hticks"]
...
try:
    ...
    y_lims = config["surface_excess_global"]["ylims"]
...
try:
    ...
    y_ticks = config["surface_excess_global"]["yticks"]
